    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnIrSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    Intent intentLogin = new Intent(RegistroCuentaActivity.this, MainActivity.class);
                    ...
                    mDatabase.child("Users").child(id).setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task2) {
                            if (task2.isSuccessful()) {
                                Intent intentProfile = new Intent( RegistroCuentaActivity.this, DashBoardActivity.class);
