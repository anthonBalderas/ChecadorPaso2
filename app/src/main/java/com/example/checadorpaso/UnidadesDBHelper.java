...
import com.example.checadorpaso.UnidadesContract.*;

public class UnidadesDBHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "registroList.db";
...
super(context, DATABASE_NAME,null,DATABASE_VERSION);
    ...
    public void onCreate(SQLiteDatabase db) {
        final String SQL_CREATE_REGISTROLIST_TABLE = "CREATE TABLE " +
                ...
                ");";
        db.execSQL(SQL_CREATE_REGISTROLIST_TABLE);

        final String SQL_CREATE_REGISTROLIST2_TABLE = "CREATE TABLE " +
        ...
        db.execSQL(SQL_CREATE_REGISTROLIST2_TABLE);

        final String SQL_CREATE_REGISTROLIST3_TABLE = "CREATE TABLE " +
        ...
        db.execSQL(SQL_CREATE_REGISTROLIST3_TABLE);

        final String SQL_CREATE_REGISTRO_HISTORIAL_TABLE = "CREATE TABLE " +
        ...
        db.execSQL(SQL_CREATE_REGISTRO_HISTORIAL_TABLE);

        final String SQL_CREATE_REGISTRO_HISTORIAL2_TABLE = "CREATE TABLE " +
        ...
        db.execSQL(SQL_CREATE_REGISTRO_HISTORIAL2_TABLE);

        final String SQL_CREATE_REGISTRO_HISTORIAL3_TABLE = "CREATE TABLE " +
        ...
        db.execSQL(SQL_CREATE_REGISTRO_HISTORIAL3_TABLE);
    }
